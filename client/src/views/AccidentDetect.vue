<template>
  <div class=" gradient" style="overflow: auto">
    ...
    <div v-if="videoSrc"  style="position: absolute;left: 25%;width:50%;top:15%;height: 73%;background-color:#0a0a0a;" class="fade-in-component">
      ...
      <!--    三维视频-->
      <video src='../views/ThreeDim/threeD.mp4'  class="fade-in-component" id="centerVideo" muted="true" v-show="ifShow3D"
             style="position: absolute;left: 0%;top: 0%;width: 100%;height: 100%;" type="video" controls="controls" autoplay
      >
        <p>你的浏览器不支持video标签.</p>
      </video>
    ...
    <div style="position: absolute;left: 0%;width:100%;height: 10%;top: 90%;" class="fade-in-component">
      ...
      <v-btn
          fab title="三维重建"
          style="position:absolute;left: 94%;top: 20%;background-color:#d6cef5;"
          @click="()=>{this.ifShow3D=!this.ifShow3D}"
      >
        <v-img src="../assets/rebuild3D.png" style="position:absolute;" width="40px"></v-img>
      </v-btn>
...
export default {
  ...
  data(){
    return{
      ...
      //中心视频区域
      videoSrc:require('../video/0F0WE.mp4'),videoName:'0F0WE',ifShowSuccess:false,successContent:'',
